...
int main() {
  ...
  printf("Dendisdade populacional: %.2f\n", densidade1);
  ...
  // Área para as comparações entre os atributos das cartas e apresentar na tela os atributos vencedores.
  printf("Carta 1\n");
  printf("Estado: %c\n", estado1);
  printf("Código: %4s\n", codigo1);
  printf("Nome da Cidade: %s\n", cidade1);
  ...
  printf("Densidade populacioanl: Carta 1 venceu %d\n", densidade1 < densidade2);
  ...
  printf("Densidade populacioanl: Carta 2 venceu %d\n", densidade2 < densidade1);
